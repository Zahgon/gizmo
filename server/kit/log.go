...
func newJSONLogger() log.Logger { _ = "STUB: not implemented"; return *new(log.Logger) }
...
func Logger(ctx context.Context) log.Logger { _ = "STUB: not implemented"; return *new(log.Logger) }

// Log will pull a request scoped log.Logger from the context and
// log the given keyvals with it.
func Log(ctx context.Context, keyvals ...interface{}) error { _ = "STUB: not implemented"; return nil }
...
func LogMsg(ctx context.Context, message string) error { _ = "STUB: not implemented"; return nil }
...
func LogDebug(ctx context.Context, message string) error { _ = "STUB: not implemented"; return nil }
...
func LogWarning(ctx context.Context, message string) error { _ = "STUB: not implemented"; return nil }
